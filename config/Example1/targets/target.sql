USE Development;
GO
IF Object_ID('source.lST_Street__NYPD_Vehicle_Collision_Typed', 'P') IS NOT NULL
DROP PROCEDURE [source].[lST_Street__NYPD_Vehicle_Collision_Typed];
GO
--------------------------------------------------------------------------
...
--------------------------------------------------------------------------
CREATE PROCEDURE [source].[lST_Street__NYPD_Vehicle_Collision_Typed] (
...
END
GO
IF Object_ID('source.lIS_Intersection__NYPD_Vehicle_Collision_Typed__1', 'P') IS NOT NULL
DROP PROCEDURE [source].[lIS_Intersection__NYPD_Vehicle_Collision_Typed__1];
GO
--------------------------------------------------------------------------
...
-- From: PWSHKDWQRF001 in the AD domain
--------------------------------------------------------------------------
CREATE PROCEDURE [source].[lIS_Intersection__NYPD_Vehicle_Collision_Typed__1] (
    @agentJobId uniqueidentifier = null,
    @agentStepId smallint = null
)
AS
...
END
GO
IF Object_ID('source.lST_intersecting_IS_of_ST_crossing__NYPD_Vehicle_Collision_Typed', 'P') IS NOT NULL
DROP PROCEDURE [source].[lST_intersecting_IS_of_ST_crossing__NYPD_Vehicle_Collision_Typed];
GO
--------------------------------------------------------------------------
...
-- From: PWSHKDWQRF001 in the AD domain
--------------------------------------------------------------------------
CREATE PROCEDURE [source].[lST_intersecting_IS_of_ST_crossing__NYPD_Vehicle_Collision_Typed] (
    @agentJobId uniqueidentifier = null,
    @agentStepId smallint = null
)
AS
...
END
GO
IF Object_ID('source.lIS_Intersection__NYPD_Vehicle_Collision_Typed__2', 'P') IS NOT NULL
DROP PROCEDURE [source].[lIS_Intersection__NYPD_Vehicle_Collision_Typed__2];
GO
--------------------------------------------------------------------------
...
-- From: PWSHKDWQRF001 in the AD domain
--------------------------------------------------------------------------
CREATE PROCEDURE [source].[lIS_Intersection__NYPD_Vehicle_Collision_Typed__2] (
    @agentJobId uniqueidentifier = null,
    @agentStepId smallint = null
)
AS
...
EXEC Development.metadata._WorkSourceToTarget
    ...
    USING (
        ...
        FROM
            source.NYPD_Vehicle_Collision_Typed src
        JOIN
            source.NYPD_Vehicle_CollisionMetadata_Typed md
        ON
